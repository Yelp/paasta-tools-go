...
// NewSmartstackStatus instantiates a new SmartstackStatus object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSmartstackStatus() *SmartstackStatus {
	this := SmartstackStatus{}
	return &this
}

// NewSmartstackStatusWithDefaults instantiates a new SmartstackStatus object
...
type NullableSmartstackStatus struct {
	value *SmartstackStatus
	isSet bool
}

func (v NullableSmartstackStatus) Get() *SmartstackStatus {
	return v.value
}

func (v *NullableSmartstackStatus) Set(val *SmartstackStatus) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSmartstackStatus(val *SmartstackStatus) *NullableSmartstackStatus {
	return &NullableSmartstackStatus{value: val, isSet: true}
}
