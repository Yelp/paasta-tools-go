...
// GetActiveShasOk returns a tuple with the ActiveShas field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InstanceStatusKubernetes) GetActiveShasOk() (*[][]string, bool) {
	if o == nil || o.ActiveShas == nil {
		return nil, false
	}
	return o.ActiveShas, true
}
...
func (o *InstanceStatusKubernetes) GetEvictedCount() int32 {
	if o == nil || o.EvictedCount == nil {
		var ret int32
		return ret
	}
	return *o.EvictedCount
}

// GetEvictedCountOk returns a tuple with the EvictedCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InstanceStatusKubernetes) GetEvictedCountOk() (*int32, bool) {
	if o == nil || o.EvictedCount == nil {
		return nil, false
	}
	return o.EvictedCount, true
}
...
func (o InstanceStatusKubernetes) MarshalJSON() ([]byte, error) {
	...
	if o.ActiveShas != nil {
		toSerialize["active_shas"] = o.ActiveShas
	}
	if true {
	...
	if o.EvictedCount != nil {
		toSerialize["evicted_count"] = o.EvictedCount
	}
