...
func (o *MarathonAutoscalingInfo) GetCurrentUtilization() float32 {
	if o == nil || o.CurrentUtilization == nil {
		var ret float32
		return ret
	}
...
// GetTargetInstances returns the TargetInstances field value if set, zero value otherwise.
func (o *MarathonAutoscalingInfo) GetTargetInstances() int32 {
	if o == nil || o.TargetInstances == nil {
		var ret int32
		return ret
	}
	return *o.TargetInstances
}
...
// SetTargetInstances gets a reference to the given int32 and assigns it to the TargetInstances field.
...
func (o MarathonAutoscalingInfo) MarshalJSON() ([]byte, error) {
	...
	if o.TargetInstances != nil {
		toSerialize["target_instances"] = o.TargetInstances
	}
